...
#define MATRIX_SIZE 5 // defined to automatize functions' output.
...
#define ACTIONS_NUMBER  25         // The number of all possible actions
...
// functions to create path_cost and sld matrix.
